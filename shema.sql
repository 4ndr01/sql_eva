...
ALTER TABLE Redirections ADD CONSTRAINT FK_Redirections_Temporaires_ID_Arret_Non_Desservi FOREIGN KEY (ID_Arret_Non_Desservi) REFERENCES Arrets (ID_Arret);
ALTER TABLE Redirections ADD CONSTRAINT FK_Redirections_Temporaires_ID_Arret_Redirection FOREIGN KEY (ID_Arret_Redirection) REFERENCES Arrets (ID_Arret);
